...
<asp:Content id="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron">
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" DataSourceID="SqlDataSource1" DataTextField="Recipe_submited_by" DataValueField="Recipe_submited_by" CssClass="dropdown" AppendDataBoundItems="True">
            <asp:ListItem Text="All" Enabled="true" Selected="True" Value="All"></asp:ListItem>
        </asp:DropDownList>
        ...
        <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource3" DataTextField="recipe_category" DataValueField="recipe_category" CssClass="dropdown" AppendDataBoundItems="True">
            <asp:ListItem Text="All" Enabled="true" Selected="True" Value="All"></asp:ListItem>
        </asp:DropDownList>
        ...
        <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource2" DataTextField="Ingredient_name" DataValueField="Ingredient_name" CssClass="dropdown" AppendDataBoundItems="True">
            <asp:ListItem Text="All" Enabled="true" Selected="True" Value="All"></asp:ListItem>
        </asp:DropDownList>
