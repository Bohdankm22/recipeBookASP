...
<asp:Content id="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource4" CssClass="table-bordered">
            <Columns>
                ...
                <asp:BoundField DataField="Recipe_submited_by" HeaderText="Submited By" ItemStyle-Width="20%" ></asp:BoundField>
