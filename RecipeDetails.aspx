...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="jumbotron">
        ...
        <a href="Recipes.aspx" class="label label-info">&#8592; Back to Recipes Page&nbsp;&nbsp;&nbsp;
        </a>

        <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="125px" DataSourceID="SqlDataSource1" CssClass="table" AutoGenerateRows="False" DataKeyNames="recipe_id" AutoGenerateDeleteButton="True">
            <Fields>
        ...
        <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource2" CssClass="table" ShowHeader="True">
            <HeaderTemplate>
